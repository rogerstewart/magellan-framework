...
namespace Magellan.Transitionals.Transitions
{
    ...
    /// </summary>
    public partial class ZoomInFrameworkElement : FrameworkElement
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="ZoomInFrameworkElement"/> class.
        /// </summary>
        public ZoomInFrameworkElement()
        {
            InitializeComponent();
        }
