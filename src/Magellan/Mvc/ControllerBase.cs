...
namespace Magellan.Mvc
{
    ...
    public abstract class ControllerBase : IController
    {
        ...
        {
            get { return _modelBinders = _modelBinders ?? Mvc.ModelBinders.CreateDefaults(); }
        ...
        {
            get { return ControllerContext == null ? Mvc.ViewEngines.CreateDefaults() : ControllerContext.ViewEngines; }
        }
