...
namespace Magellan.Mvc
{
    ...
    public class DefaultModelBinder : IModelBinder
    {
        ...
        public object BindModel(ControllerContext controllerContext, ModelBindingContext bindingContext)
        {
            ...
            {
                TraceSources.MagellanSource.TraceError("DefaultModelBinder could not find a parameter '{0}' for the action method '{1}' in the list of navigation parameters.", controllerContext.Request.RouteValues, bindingContext.TargetParameterName);
