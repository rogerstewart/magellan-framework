...
namespace Magellan.Framework
{
    ...
    public class PageViewEngine : ReflectionBasedViewEngine, IViewNamingConvention
    {
        ...
        {
            return viewParameters.GetOrDefault<string>(WellKnownParameters.ViewType) == "Page"
        ...
        {
            return new PageViewEngineResult(_viewActivator, type, viewParameters, controllerContext);
        }
    }
}