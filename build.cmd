...
"%SystemDrive%\Windows\Microsoft.NET\Framework\v4.0.30319\MSBuild.exe" build\Local.proj /t:Package /p:build_version=2.1.1 /verbosity:minimal /p:build_number=2.0.1.1 /nologo
